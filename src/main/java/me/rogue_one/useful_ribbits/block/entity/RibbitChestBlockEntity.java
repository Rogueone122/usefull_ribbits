...
public class RibbitChestBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public RibbitChestBlockEntity(BlockPos position, BlockState state) {
		super(UsefulRibbitsModBlockEntities.RIBBIT_CHEST.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("ribbit_chest");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RibbitChestGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
