...
public class RibbitBedGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RibbitBedGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 79, 9) {
			private final int slot = 0;
			private int x = RibbitBedGUIMenu.this.x;
			private int y = RibbitBedGUIMenu.this.y;
		}));
