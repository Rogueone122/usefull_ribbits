...
public class RibbitChestGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RibbitChestGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 8, 20) {
			...
			private int x = RibbitChestGUIMenu.this.x;
			private int y = RibbitChestGUIMenu.this.y;
		}));
		...
		RibbitChestGUIThisGUIIsOpenedProcedure.execute(world, x, y, z);
	}
	...
	public void removed(Player playerIn) {
		...
		RibbitChestGUIThisGUIIsClosedProcedure.execute(world, x, y, z);
