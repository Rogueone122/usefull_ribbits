...
@Mod("useful_ribbits")
public class UsefulRibbitsMod {
	public static final Logger LOGGER = LogManager.getLogger(UsefulRibbitsMod.class);
	public static final String MODID = "useful_ribbits";

	public UsefulRibbitsMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		UsefulRibbitsModSounds.REGISTRY.register(bus);
		UsefulRibbitsModBlocks.REGISTRY.register(bus);
		UsefulRibbitsModBlockEntities.REGISTRY.register(bus);
		UsefulRibbitsModItems.REGISTRY.register(bus);
		UsefulRibbitsModEntities.REGISTRY.register(bus);

		UsefulRibbitsModTabs.REGISTRY.register(bus);

		UsefulRibbitsModMenus.REGISTRY.register(bus);
